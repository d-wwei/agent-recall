# Feature Parity: Agent Recall Hooks vs Cursor Hooks

This document compares Agent Recall's Claude Code hooks with the Cursor hooks implementation to ensure feature parity.
...
**How it works**:
- Hook writes context to `.cursor/rules/agent-recall-context.mdc`
...
### Tag Stripping
- **Claude Code**: Worker handles `<private>` and `<agent-recall-context>` tags
...
**Overall**: The Cursor hooks implementation achieves **full functional parity** with Agent Recall's Claude Code hooks:
