...
function printHelp(): void {
  console.log(`
bug-report - Generate bug reports for Agent Recall
...
DESCRIPTION:
  ...
  and generates a formatted GitHub issue for Agent Recall using the Claude Agent SDK.
...
async function main() {
  ...
  const githubUrl = `https://github.com/agent-recall/agent-recall/issues/new?title=${encodedTitle}&body=${encodedBody}`;
