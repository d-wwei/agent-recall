...
/**
 * Release script for Agent Recall
...
async function publish() {
  try {
    console.log('📦 Agent Recall Marketplace Release Tool\n');
...
https://github.com/agent-recall/agent-recall"`);
    ...
    console.log(`\n🏷️  Tag: https://github.com/agent-recall/agent-recall/releases/tag/v${newVersion}`);
