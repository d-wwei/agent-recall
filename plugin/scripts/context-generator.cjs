"use strict";var bt=Object.create;var x=Object.defineProperty;var St=Object.getOwnPropertyDescriptor;var ht=Object.getOwnPropertyNames;var Rt=Object.getPrototypeOf,ft=Object.prototype.hasOwnProperty;var It=(n,e)=>{for(var t in e)x(n,t,{get:e[t],enumerable:!0})},Ee=(n,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of ht(e))!ft.call(n,r)&&r!==t&&x(n,r,{get:()=>e[r],enumerable:!(s=St(e,r))||s.enumerable});return n};var k=(n,e,t)=>(t=n!=null?bt(Rt(n)):{},Ee(e||!n||!n.__esModule?x(t,"default",{value:n,enumerable:!0}):t,n)),Ot=n=>Ee(x({},"__esModule",{value:!0}),n);var Bt={};It(Bt,{generateContext:()=>_e});module.exports=Ot(Bt);var lt=k(require("path"),1),Tt=require("os"),gt=require("fs");var be=require("bun:sqlite");var N=require("path"),w=require("os"),L=require("fs");var ce=require("url");var A=require("fs"),v=require("path"),ue=require("os"),J=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(J||{}),pe=(0,v.join)((0,ue.homedir)(),".agent-recall"),Q=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,v.join)(pe,"logs");(0,A.existsSync)(e)||(0,A.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,v.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,v.join)(pe,"settings.json");if((0,A.existsSync)(e)){let t=(0,A.readFileSync)(e,"utf-8"),r=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=J[r]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
