"use strict";var Nt=Object.create;var x=Object.defineProperty;var St=Object.getOwnPropertyDescriptor;var ht=Object.getOwnPropertyNames;var Rt=Object.getPrototypeOf,ft=Object.prototype.hasOwnProperty;var It=(n,e)=>{for(var t in e)x(n,t,{get:e[t],enumerable:!0})},Ee=(n,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of ht(e))!ft.call(n,r)&&r!==t&&x(n,r,{get:()=>e[r],enumerable:!(s=St(e,r))||s.enumerable});return n};var k=(n,e,t)=>(t=n!=null?Nt(Rt(n)):{},Ee(e||!n||!n.__esModule?x(t,"default",{value:n,enumerable:!0}):t,n)),Ot=n=>Ee(x({},"__esModule",{value:!0}),n);var Bt={};It(Bt,{generateContext:()=>_e});module.exports=Ot(Bt);var lt=k(require("path"),1),Tt=require("os"),gt=require("fs");var Ne=require("bun:sqlite");var N=require("path"),w=require("os"),v=require("fs");var ce=require("url");var A=require("fs"),L=require("path"),ue=require("os"),J=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(J||{}),pe=(0,L.join)((0,ue.homedir)(),".agent-recall"),Q=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,L.join)(pe,"logs");(0,A.existsSync)(e)||(0,A.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,L.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,L.join)(pe,"settings.json");if((0,A.existsSync)(e)){let t=(0,A.readFileSync)(e,"utf-8"),r=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=J[r]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):u=" "+this.formatData(o));let m="";if(r){let{sessionId:g,memorySessionId:S,correlationId:h,...c}=r;Object.keys(c).length>0&&(m=` {${Object.entries(c).map(([T,R])=>`${T}=${R}`).join(", ")}}`)}let l=`[${i}] [${a}] [${d}] ${p}${s}${m}${u}`;if(this.logFilePath)try{(0,A.appendFileSync)(this.logFilePath,l+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=p?`${p[1].split("/").pop()}:${p[2]}`:"unknown",m={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,m,r),o}},_=new Q;var Dt={};function At(){return typeof __dirname<"u"?__dirname:(0,N.dirname)((0,ce.fileURLToPath)(Dt.url))}var Ct=At(),Lt=(0,N.join)((0,w.homedir)(),".claude-mem");function vt(){if(process.env.AGENT_RECALL_DATA_DIR)return process.env.AGENT_RECALL_DATA_DIR;if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let n=(0,N.join)((0,w.homedir)(),".agent-recall"),e=(0,N.join)(n,"settings.json");try{if((0,v.existsSync)(e)){let{readFileSync:s}=require("fs"),r=JSON.parse(s(e,"utf-8")),o=r.env??r;if(o.AGENT_RECALL_DATA_DIR||o.CLAUDE_MEM_DATA_DIR)return o.AGENT_RECALL_DATA_DIR||o.CLAUDE_MEM_DATA_DIR}}catch{}let t=(0,N.join)(Lt,"settings.json");try{if((0,v.existsSync)(t)){let{readFileSync:s}=require("fs"),r=JSON.parse(s(t,"utf-8")),o=r.env??r;if(o.CLAUDE_MEM_DATA_DIR)return o.CLAUDE_MEM_DATA_DIR}}catch{}return n}var I=vt(),C=process.env.CLAUDE_CONFIG_DIR||(0,N.join)((0,w.homedir)(),".claude"),qt=(0,N.join)(C,"plugins","marketplaces","agent-recall"),Kt=(0,N.join)(C,"plugins","marketplaces","thedotmack"),Jt=(0,N.join)(I,"archives"),Qt=(0,N.join)(I,"logs"),zt=(0,N.join)(I,"trash"),Zt=(0,N.join)(I,"backups"),es=(0,N.join)(I,"modes"),me=(0,N.join)(I,"settings.json"),le=(0,N.join)(I,"agent-recall.db");var ts=(0,N.join)(I,"vector-db"),ss=(0,N.join)(I,"observer-sessions"),rs=(0,N.join)(C,"settings.json"),ns=(0,N.join)(C,"commands"),os=(0,N.join)(C,"CLAUDE.md");function Te(n){(0,v.mkdirSync)(n,{recursive:!0})}function ge(){return(0,N.join)(Ct,"..")}var be=require("crypto");var yt=3e4;function X(n,e,t){return(0,be.createHash)("sha256").update((n||"")+(e||"")+(t||"")).digest("hex").slice(0,16)}function F(n,e,t){let s=t-yt;return n.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}var P=class{constructor(e){this.db=e}runAllMigrations(){this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.createAgentRecallCoreTables(),this.addScopeColumns(),this.createSessionArchivesTable()}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:r,project:o,type:i,concepts:a,files:d}=t,p=s==="date_asc"?"ASC":"DESC",u=r?`LIMIT ${r}`:"",m=e.map(()=>"?").join(","),l=[...e],g=[];if(o&&(g.push("project = ?"),l.push(o)),i)if(Array.isArray(i)){let c=i.map(()=>"?").join(",");g.push(`type IN (${c})`),l.push(...i)}else g.push("type = ?"),l.push(i);if(a){let c=Array.isArray(a)?a:[a],b=c.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");l.push(...c),g.push(`(${b.join(" OR ")})`)}if(d){let c=Array.isArray(d)?d:[d],b=c.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");c.forEach(T=>{l.push(`%${T}%`,`%${T}%`)}),g.push(`(${b.join(" OR ")})`)}let S=g.length>0?`WHERE id IN (${m}) AND ${g.join(" AND ")}`:`WHERE id IN (${m})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${S}
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,r||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,r,o,i=0,a){let d=a??Date.now(),p=new Date(d).toISOString();return this.db.transaction(()=>{let m=[],l=this.db.prepare(`
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let S of s){let h=X(e,S.title,S.narrative),c=F(this.db,h,d);if(c){m.push(c.id);continue}let b=l.run(e,t,S.type,S.title,S.subtitle,JSON.stringify(S.facts),S.narrative,JSON.stringify(S.concepts),JSON.stringify(S.files_read),JSON.stringify(S.files_modified),o||null,i,h,p,d);m.push(Number(b.lastInsertRowid))}let g=null;if(r){let h=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,o||null,i,p,d);g=Number(h.lastInsertRowid)}return{observationIds:m,summaryId:g,createdAtEpoch:d}})()}storeObservationsAndMarkComplete(e,t,s,r,o,i,a,d=0,p){let u=p??Date.now(),m=new Date(u).toISOString();return this.db.transaction(()=>{let g=[],S=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let b of s){let T=X(e,b.title,b.narrative),R=F(this.db,T,u);if(R){g.push(R.id);continue}let bt=S.run(e,t,b.type,b.title,b.subtitle,JSON.stringify(b.facts),b.narrative,JSON.stringify(b.concepts),JSON.stringify(b.files_read),JSON.stringify(b.files_modified),a||null,d,T,m,u);g.push(Number(bt.lastInsertRowid))}let h;if(r){let T=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,a||null,d,m,u);h=Number(T.lastInsertRowid)}return this.db.prepare(`
      ...
      `).run(u,o),{observationIds:g,summaryId:h,createdAtEpoch:u}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:r,project:o}=t,i=s==="date_asc"?"ASC":"DESC",a=r?`LIMIT ${r}`:"",d=e.map(()=>"?").join(","),p=[...e],u=o?`WHERE id IN (${d}) AND project = ?`:`WHERE id IN (${d})`;return o&&p.push(o),this.db.prepare(`
    ...
    `).all(...p)}getTimelineAroundTimestamp(e,t=10,s=10,r){return this.getTimelineAroundObservation(null,e,t,s,r)}getTimelineAroundObservation(e,t,s=10,r=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,p;if(e!==null){let c=`
      ...
      `,b=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let T=this.db.prepare(c).all(e,...a,s+1),R=this.db.prepare(b).all(e,...a,r+1);if(T.length===0&&R.length===0)return{observations:[],sessions:[],prompts:[]};d=T.length>0?T[T.length-1].created_at_epoch:t,p=R.length>0?R[R.length-1].created_at_epoch:t}catch(T){return _.error("DB","Error getting boundary observations",void 0,{error:T,project:o}),{observations:[],sessions:[],prompts:[]}}}else{let c=`
      ...
      `,b=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let T=this.db.prepare(c).all(t,...a,s),R=this.db.prepare(b).all(t,...a,r+1);if(T.length===0&&R.length===0)return{observations:[],sessions:[],prompts:[]};d=T.length>0?T[T.length-1].created_at_epoch:t,p=R.length>0?R[R.length-1].created_at_epoch:t}catch(T){return _.error("DB","Error getting boundary timestamps",void 0,{error:T,project:o}),{observations:[],sessions:[],prompts:[]}}}let u=`
      SELECT *
      FROM observations
