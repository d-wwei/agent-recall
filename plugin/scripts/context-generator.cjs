"use strict";var Nt=Object.create;var x=Object.defineProperty;var St=Object.getOwnPropertyDescriptor;var ht=Object.getOwnPropertyNames;var Rt=Object.getPrototypeOf,ft=Object.prototype.hasOwnProperty;var It=(n,e)=>{for(var t in e)x(n,t,{get:e[t],enumerable:!0})},Ee=(n,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of ht(e))!ft.call(n,r)&&r!==t&&x(n,r,{get:()=>e[r],enumerable:!(s=St(e,r))||s.enumerable});return n};var k=(n,e,t)=>(t=n!=null?Nt(Rt(n)):{},Ee(e||!n||!n.__esModule?x(t,"default",{value:n,enumerable:!0}):t,n)),Ot=n=>Ee(x({},"__esModule",{value:!0}),n);var jt={};It(jt,{generateContext:()=>_e});module.exports=Ot(jt);var lt=k(require("path"),1),Tt=require("os"),gt=require("fs");var Ne=require("bun:sqlite");var N=require("path"),w=require("os"),v=require("fs");var ce=require("url");var A=require("fs"),L=require("path"),ue=require("os"),J=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(J||{}),pe=(0,L.join)((0,ue.homedir)(),".agent-recall"),Q=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,L.join)(pe,"logs");(0,A.existsSync)(e)||(0,A.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,L.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,L.join)(pe,"settings.json");if((0,A.existsSync)(e)){let t=(0,A.readFileSync)(e,"utf-8"),r=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=J[r]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):u=" "+this.formatData(o));let m="";if(r){let{sessionId:l,memorySessionId:S,correlationId:h,...c}=r;Object.keys(c).length>0&&(m=` {${Object.entries(c).map(([g,R])=>`${g}=${R}`).join(", ")}}`)}let T=`[${i}] [${a}] [${d}] ${p}${s}${m}${u}`;if(this.logFilePath)try{(0,A.appendFileSync)(this.logFilePath,T+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=p?`${p[1].split("/").pop()}:${p[2]}`:"unknown",m={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,m,r),o}},_=new Q;var Dt={};function At(){return typeof __dirname<"u"?__dirname:(0,N.dirname)((0,ce.fileURLToPath)(Dt.url))}var Ct=At(),Lt=(0,N.join)((0,w.homedir)(),".claude-mem");function vt(){if(process.env.AGENT_RECALL_DATA_DIR)return process.env.AGENT_RECALL_DATA_DIR;if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let n=(0,N.join)((0,w.homedir)(),".agent-recall"),e=(0,N.join)(n,"settings.json");try{if((0,v.existsSync)(e)){let{readFileSync:s}=require("fs"),r=JSON.parse(s(e,"utf-8")),o=r.env??r;if(o.AGENT_RECALL_DATA_DIR||o.CLAUDE_MEM_DATA_DIR)return o.AGENT_RECALL_DATA_DIR||o.CLAUDE_MEM_DATA_DIR}}catch{}let t=(0,N.join)(Lt,"settings.json");try{if((0,v.existsSync)(t)){let{readFileSync:s}=require("fs"),r=JSON.parse(s(t,"utf-8")),o=r.env??r;if(o.CLAUDE_MEM_DATA_DIR)return o.CLAUDE_MEM_DATA_DIR}}catch{}return n}var I=vt(),C=process.env.CLAUDE_CONFIG_DIR||(0,N.join)((0,w.homedir)(),".claude"),qt=(0,N.join)(C,"plugins","marketplaces","agent-recall"),Kt=(0,N.join)(C,"plugins","marketplaces","thedotmack"),Jt=(0,N.join)(I,"archives"),Qt=(0,N.join)(I,"logs"),zt=(0,N.join)(I,"trash"),Zt=(0,N.join)(I,"backups"),es=(0,N.join)(I,"modes"),me=(0,N.join)(I,"settings.json"),le=(0,N.join)(I,"agent-recall.db");var ts=(0,N.join)(I,"vector-db"),ss=(0,N.join)(I,"observer-sessions"),rs=(0,N.join)(C,"settings.json"),ns=(0,N.join)(C,"commands"),os=(0,N.join)(C,"CLAUDE.md");function Te(n){(0,v.mkdirSync)(n,{recursive:!0})}function ge(){return(0,N.join)(Ct,"..")}var be=require("crypto");var yt=3e4;function X(n,e,t){return(0,be.createHash)("sha256").update((n||"")+(e||"")+(t||"")).digest("hex").slice(0,16)}function F(n,e,t){let s=t-yt;return n.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}var P=class{constructor(e){this.db=e}runAllMigrations(){this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.createAgentRecallCoreTables(),this.addScopeColumns(),this.createSessionArchivesTable()}initializeSchema(){this.db.run(`
    ...
    `),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_session ON pending_messages(session_db_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_status ON pending_messages(status)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_claude_session ON pending_messages(content_session_id)"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(16,new Date().toISOString()),_.debug("DB","pending_messages table created successfully")}renameSessionIdColumns(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(17))return;_.debug("DB","Checking session ID columns for semantic clarity rename");let t=0,s=(r,o,i)=>{let a=this.db.query(`PRAGMA table_info(${r})`).all(),d=a.some(u=>u.name===o);return a.some(u=>u.name===i)?!1:d?(this.db.run(`ALTER TABLE ${r} RENAME COLUMN ${o} TO ${i}`),_.debug("DB",`Renamed ${r}.${o} to ${i}`),!0):(_.warn("DB",`Column ${o} not found in ${r}, skipping rename`),!1)};s("sdk_sessions","claude_session_id","content_session_id")&&t++,s("sdk_sessions","sdk_session_id","memory_session_id")&&t++,s("pending_messages","claude_session_id","content_session_id")&&t++,s("observations","sdk_session_id","memory_session_id")&&t++,s("session_summaries","sdk_session_id","memory_session_id")&&t++,s("user_prompts","claude_session_id","content_session_id")&&t++,this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(17,new Date().toISOString()),t>0?_.debug("DB",`Successfully renamed ${t} session ID columns`):_.debug("DB","No session ID column renames needed (already up to date)")}repairSessionIdColumnRename(){this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(19)||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(19,new Date().toISOString())}addFailedAtEpochColumn(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(20))return;this.db.query("PRAGMA table_info(pending_messages)").all().some(r=>r.name==="failed_at_epoch")||(this.db.run("ALTER TABLE pending_messages ADD COLUMN failed_at_epoch INTEGER"),_.debug("DB","Added failed_at_epoch column to pending_messages table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(20,new Date().toISOString())}addOnUpdateCascadeToForeignKeys(){if(!this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(21)){_.debug("DB","Adding ON UPDATE CASCADE to FK constraints on observations and session_summaries"),this.db.run("PRAGMA foreign_keys = OFF"),this.db.run("BEGIN TRANSACTION");try{this.db.run("DROP TRIGGER IF EXISTS observations_ai"),this.db.run("DROP TRIGGER IF EXISTS observations_ad"),this.db.run("DROP TRIGGER IF EXISTS observations_au"),this.db.run("DROP TABLE IF EXISTS observations_new"),this.db.run(`
      ...
      `),this.db.run("COMMIT"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(26,new Date().toISOString()),_.debug("DB","session_archives and sync_policies tables created")}catch(t){throw this.db.run("ROLLBACK"),t}}}};var G=class{db;constructor(e=le){e!==":memory:"&&Te(I),this.db=new Ne.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),new P(this.db).runAllMigrations()}initializeSchema(){this.db.run(`
      CREATE TABLE IF NOT EXISTS schema_versions (
        id INTEGER PRIMARY KEY,
        version INTEGER UNIQUE NOT NULL,
        applied_at TEXT NOT NULL
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:r,project:o,type:i,concepts:a,files:d}=t,p=s==="date_asc"?"ASC":"DESC",u=r?`LIMIT ${r}`:"",m=e.map(()=>"?").join(","),T=[...e],l=[];if(o&&(l.push("project = ?"),T.push(o)),i)if(Array.isArray(i)){let c=i.map(()=>"?").join(",");l.push(`type IN (${c})`),T.push(...i)}else l.push("type = ?"),T.push(i);if(a){let c=Array.isArray(a)?a:[a],b=c.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");T.push(...c),l.push(`(${b.join(" OR ")})`)}if(d){let c=Array.isArray(d)?d:[d],b=c.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");c.forEach(g=>{T.push(`%${g}%`,`%${g}%`)}),l.push(`(${b.join(" OR ")})`)}let S=l.length>0?`WHERE id IN (${m}) AND ${l.join(" AND ")}`:`WHERE id IN (${m})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${S}
    ...
    `).run(e,t,s,r.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,r,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),p=X(e,s.title,s.narrative),u=F(this.db,p,a);if(u)return{id:u.id,createdAtEpoch:u.created_at_epoch};let T=this.db.prepare(`
      INSERT INTO observations
      (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
       files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),r||null,o,p,d,a);return{id:Number(T.lastInsertRowid),createdAtEpoch:a}}storeSummary(e,t,s,r,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),u=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,r||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,r,o,i=0,a){let d=a??Date.now(),p=new Date(d).toISOString();return this.db.transaction(()=>{let m=[],T=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let S of s){let h=X(e,S.title,S.narrative),c=F(this.db,h,d);if(c){m.push(c.id);continue}let b=T.run(e,t,S.type,S.title,S.subtitle,JSON.stringify(S.facts),S.narrative,JSON.stringify(S.concepts),JSON.stringify(S.files_read),JSON.stringify(S.files_modified),o||null,i,h,p,d);m.push(Number(b.lastInsertRowid))}let l=null;if(r){let h=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,o||null,i,p,d);l=Number(h.lastInsertRowid)}return{observationIds:m,summaryId:l,createdAtEpoch:d}})()}storeObservationsAndMarkComplete(e,t,s,r,o,i,a,d=0,p){let u=p??Date.now(),m=new Date(u).toISOString();return this.db.transaction(()=>{let l=[],S=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let b of s){let g=X(e,b.title,b.narrative),R=F(this.db,g,u);if(R){l.push(R.id);continue}let bt=S.run(e,t,b.type,b.title,b.subtitle,JSON.stringify(b.facts),b.narrative,JSON.stringify(b.concepts),JSON.stringify(b.files_read),JSON.stringify(b.files_modified),a||null,d,g,m,u);l.push(Number(bt.lastInsertRowid))}let h;if(r){let g=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,a||null,d,m,u);h=Number(g.lastInsertRowid)}return this.db.prepare(`
      ...
      `).run(u,o),{observationIds:l,summaryId:h,createdAtEpoch:u}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:r,project:o}=t,i=s==="date_asc"?"ASC":"DESC",a=r?`LIMIT ${r}`:"",d=e.map(()=>"?").join(","),p=[...e],u=o?`WHERE id IN (${d}) AND project = ?`:`WHERE id IN (${d})`;return o&&p.push(o),this.db.prepare(`
    ...
    `).all(...p)}getTimelineAroundTimestamp(e,t=10,s=10,r){return this.getTimelineAroundObservation(null,e,t,s,r)}getTimelineAroundObservation(e,t,s=10,r=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,p;if(e!==null){let c=`
      ...
      `,b=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let g=this.db.prepare(c).all(e,...a,s+1),R=this.db.prepare(b).all(e,...a,r+1);if(g.length===0&&R.length===0)return{observations:[],sessions:[],prompts:[]};d=g.length>0?g[g.length-1].created_at_epoch:t,p=R.length>0?R[R.length-1].created_at_epoch:t}catch(g){return _.error("DB","Error getting boundary observations",void 0,{error:g,project:o}),{observations:[],sessions:[],prompts:[]}}}else{let c=`
...
`):s}function Bt(n,e,t,s,r,o,i,a,d){let p=[];if(a&&p.push(...ct(a,i)),d&&p.push(...mt(d,i)),!d&&t.length>0&&t[0].next_steps){let g=t[0].next_steps.trim();g&&(i?p.push(`\x1B[33m\u25C6 Last session's next steps:\x1B[0m ${g}`,""):p.push(`**Last session's next steps:** ${g}`,""))}let u=te(e);p.push(...rt(n,u,s,i));let m=t.slice(0,s.sessionCount),T=Ce(m,t),l=oe(e,T),S=Le(e,s.fullObservationCount);p.push(...dt(l,S,s,r,i));let h=t[0],c=e[0];_t(s,h,c)&&p.push(...Et(h,i));let b=ne(e,s,o,r);return p.push(...pt(b,i)),p.push(...ut(u,s,i)),p.join(`
`).trimEnd()}async function _e(n,e=!1){let t=z(),s=n?.cwd??process.cwd(),r=he(s),o=n?.projects||[r];n?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let i=Gt();if(!i)return"";try{let a=o.length>1?Oe(i,o,t):se(i,r,t),d=o.length>1?Ae(i,o,t):re(i,r,t),p=null,u=null,m=null;try{let l=new K(i.db);p=l.getMergedPersona(r),u=l.getActiveTask(r),m=l.getBootstrapStatus("__global__")}catch(l){_.debug("CONTEXT","Persona query skipped (tables may not exist yet)",{},l)}return a.length===0&&d.length===0&&!p?.agent_soul?.name?$t(r,e,m):Bt(r,a,d,t,s,n?.session_id,e,p,u)}finally{i.close()}}0&&(module.exports={generateContext});
