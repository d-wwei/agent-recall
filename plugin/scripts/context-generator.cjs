"use strict";var St=Object.create;var x=Object.defineProperty;var ft=Object.getOwnPropertyDescriptor;var Rt=Object.getOwnPropertyNames;var It=Object.getPrototypeOf,Ot=Object.prototype.hasOwnProperty;var At=(n,e)=>{for(var t in e)x(n,t,{get:e[t],enumerable:!0})},pe=(n,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of Rt(e))!Ot.call(n,r)&&r!==t&&x(n,r,{get:()=>e[r],enumerable:!(s=ft(e,r))||s.enumerable});return n};var k=(n,e,t)=>(t=n!=null?St(It(n)):{},pe(e||!n||!n.__esModule?x(t,"default",{value:n,enumerable:!0}):t,n)),Ct=n=>pe(x({},"__esModule",{value:!0}),n);var Vt={};At(Vt,{generateContext:()=>Ee});module.exports=Ct(Vt);var gt=k(require("path"),1),bt=require("os"),Nt=require("fs");var he=require("bun:sqlite");var N=require("path"),w=require("os"),v=require("fs");var me=require("url");var A=require("fs"),L=require("path"),ue=require("os"),J=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(J||{}),ce=(0,L.join)((0,ue.homedir)(),".agent-recall"),Q=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,L.join)(ce,"logs");(0,A.existsSync)(e)||(0,A.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,L.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,L.join)(ce,"settings.json");if((0,A.existsSync)(e)){let t=(0,A.readFileSync)(e,"utf-8"),r=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=J[r]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):c=" "+this.formatData(o));let m="";if(r){let{sessionId:l,memorySessionId:h,correlationId:S,...u}=r;Object.keys(u).length>0&&(m=` {${Object.entries(u).map(([g,f])=>`${g}=${f}`).join(", ")}}`)}let T=`[${i}] [${a}] [${d}] ${p}${s}${m}${c}`;if(this.logFilePath)try{(0,A.appendFileSync)(this.logFilePath,T+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),c=p?`${p[1].split("/").pop()}:${p[2]}`:"unknown",m={...s,location:c};return this.warn(e,`[HAPPY-PATH] ${t}`,m,r),o}},_=new Q;var Mt={};function Lt(){return typeof __dirname<"u"?__dirname:(0,N.dirname)((0,me.fileURLToPath)(Mt.url))}var vt=Lt(),Dt=(0,N.join)((0,w.homedir)(),".claude-mem");function yt(){if(process.env.AGENT_RECALL_DATA_DIR)return process.env.AGENT_RECALL_DATA_DIR;if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let n=(0,N.join)((0,w.homedir)(),".agent-recall"),e=(0,N.join)(n,"settings.json");try{if((0,v.existsSync)(e)){let{readFileSync:s}=require("fs"),r=JSON.parse(s(e,"utf-8")),o=r.env??r;if(o.AGENT_RECALL_DATA_DIR||o.CLAUDE_MEM_DATA_DIR)return o.AGENT_RECALL_DATA_DIR||o.CLAUDE_MEM_DATA_DIR}}catch{}let t=(0,N.join)(Dt,"settings.json");try{if((0,v.existsSync)(t)){let{readFileSync:s}=require("fs"),r=JSON.parse(s(t,"utf-8")),o=r.env??r;if(o.CLAUDE_MEM_DATA_DIR)return o.CLAUDE_MEM_DATA_DIR}}catch{}return n}var I=yt(),C=process.env.CLAUDE_CONFIG_DIR||(0,N.join)((0,w.homedir)(),".claude"),Qt=(0,N.join)(C,"plugins","marketplaces","agent-recall"),zt=(0,N.join)(C,"plugins","marketplaces","thedotmack"),Zt=(0,N.join)(I,"archives"),es=(0,N.join)(I,"logs"),ts=(0,N.join)(I,"trash"),ss=(0,N.join)(I,"backups"),rs=(0,N.join)(I,"modes"),le=(0,N.join)(I,"settings.json"),Te=(0,N.join)(I,"agent-recall.db");var ns=(0,N.join)(I,"vector-db"),os=(0,N.join)(I,"observer-sessions"),is=(0,N.join)(C,"settings.json"),as=(0,N.join)(C,"commands"),ds=(0,N.join)(C,"CLAUDE.md");function ge(n){(0,v.mkdirSync)(n,{recursive:!0})}function be(){return(0,N.join)(vt,"..")}var Ne=require("crypto");var Ut=3e4;function X(n,e,t){return(0,Ne.createHash)("sha256").update((n||"")+(e||"")+(t||"")).digest("hex").slice(0,16)}function F(n,e,t){let s=t-Ut;return n.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}var P=class{constructor(e){this.db=e}runAllMigrations(){this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.createAgentRecallCoreTables(),this.addScopeColumns(),this.createSessionArchivesTable()}initializeSchema(){this.db.run(`
    ...
    `),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_session ON pending_messages(session_db_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_status ON pending_messages(status)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_claude_session ON pending_messages(content_session_id)"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(16,new Date().toISOString()),_.debug("DB","pending_messages table created successfully")}renameSessionIdColumns(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(17))return;_.debug("DB","Checking session ID columns for semantic clarity rename");let t=0,s=(r,o,i)=>{let a=this.db.query(`PRAGMA table_info(${r})`).all(),d=a.some(c=>c.name===o);return a.some(c=>c.name===i)?!1:d?(this.db.run(`ALTER TABLE ${r} RENAME COLUMN ${o} TO ${i}`),_.debug("DB",`Renamed ${r}.${o} to ${i}`),!0):(_.warn("DB",`Column ${o} not found in ${r}, skipping rename`),!1)};s("sdk_sessions","claude_session_id","content_session_id")&&t++,s("sdk_sessions","sdk_session_id","memory_session_id")&&t++,s("pending_messages","claude_session_id","content_session_id")&&t++,s("observations","sdk_session_id","memory_session_id")&&t++,s("session_summaries","sdk_session_id","memory_session_id")&&t++,s("user_prompts","claude_session_id","content_session_id")&&t++,this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(17,new Date().toISOString()),t>0?_.debug("DB",`Successfully renamed ${t} session ID columns`):_.debug("DB","No session ID column renames needed (already up to date)")}repairSessionIdColumnRename(){this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(19)||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(19,new Date().toISOString())}addFailedAtEpochColumn(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(20))return;this.db.query("PRAGMA table_info(pending_messages)").all().some(r=>r.name==="failed_at_epoch")||(this.db.run("ALTER TABLE pending_messages ADD COLUMN failed_at_epoch INTEGER"),_.debug("DB","Added failed_at_epoch column to pending_messages table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(20,new Date().toISOString())}addOnUpdateCascadeToForeignKeys(){if(!this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(21)){_.debug("DB","Adding ON UPDATE CASCADE to FK constraints on observations and session_summaries"),this.db.run("PRAGMA foreign_keys = OFF"),this.db.run("BEGIN TRANSACTION");try{this.db.run("DROP TRIGGER IF EXISTS observations_ai"),this.db.run("DROP TRIGGER IF EXISTS observations_ad"),this.db.run("DROP TRIGGER IF EXISTS observations_au"),this.db.run("DROP TABLE IF EXISTS observations_new"),this.db.run(`
      ...
      `),this.db.run("COMMIT"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(26,new Date().toISOString()),_.debug("DB","session_archives and sync_policies tables created")}catch(t){throw this.db.run("ROLLBACK"),t}}}};var G=class{db;constructor(e=Te){e!==":memory:"&&ge(I),this.db=new he.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),new P(this.db).runAllMigrations()}initializeSchema(){this.db.run(`
      CREATE TABLE IF NOT EXISTS schema_versions (
        id INTEGER PRIMARY KEY,
        version INTEGER UNIQUE NOT NULL,
        applied_at TEXT NOT NULL
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:r,project:o,type:i,concepts:a,files:d}=t,p=s==="date_asc"?"ASC":"DESC",c=r?`LIMIT ${r}`:"",m=e.map(()=>"?").join(","),T=[...e],l=[];if(o&&(l.push("project = ?"),T.push(o)),i)if(Array.isArray(i)){let u=i.map(()=>"?").join(",");l.push(`type IN (${u})`),T.push(...i)}else l.push("type = ?"),T.push(i);if(a){let u=Array.isArray(a)?a:[a],b=u.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");T.push(...u),l.push(`(${b.join(" OR ")})`)}if(d){let u=Array.isArray(d)?d:[d],b=u.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");u.forEach(g=>{T.push(`%${g}%`,`%${g}%`)}),l.push(`(${b.join(" OR ")})`)}let h=l.length>0?`WHERE id IN (${m}) AND ${l.join(" AND ")}`:`WHERE id IN (${m})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${h}
    ...
    `).run(e,t,s,r.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,r,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),p=X(e,s.title,s.narrative),c=F(this.db,p,a);if(c)return{id:c.id,createdAtEpoch:c.created_at_epoch};let T=this.db.prepare(`
      INSERT INTO observations
      (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
       files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),r||null,o,p,d,a);return{id:Number(T.lastInsertRowid),createdAtEpoch:a}}storeSummary(e,t,s,r,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),c=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,r||null,o,d,a);return{id:Number(c.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,r,o,i=0,a){let d=a??Date.now(),p=new Date(d).toISOString();return this.db.transaction(()=>{let m=[],T=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let h of s){let S=X(e,h.title,h.narrative),u=F(this.db,S,d);if(u){m.push(u.id);continue}let b=T.run(e,t,h.type,h.title,h.subtitle,JSON.stringify(h.facts),h.narrative,JSON.stringify(h.concepts),JSON.stringify(h.files_read),JSON.stringify(h.files_modified),o||null,i,S,p,d);m.push(Number(b.lastInsertRowid))}let l=null;if(r){let S=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,o||null,i,p,d);l=Number(S.lastInsertRowid)}return{observationIds:m,summaryId:l,createdAtEpoch:d}})()}storeObservationsAndMarkComplete(e,t,s,r,o,i,a,d=0,p){let c=p??Date.now(),m=new Date(c).toISOString();return this.db.transaction(()=>{let l=[],h=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let b of s){let g=X(e,b.title,b.narrative),f=F(this.db,g,c);if(f){l.push(f.id);continue}let ht=h.run(e,t,b.type,b.title,b.subtitle,JSON.stringify(b.facts),b.narrative,JSON.stringify(b.concepts),JSON.stringify(b.files_read),JSON.stringify(b.files_modified),a||null,d,g,m,c);l.push(Number(ht.lastInsertRowid))}let S;if(r){let g=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,a||null,d,m,c);S=Number(g.lastInsertRowid)}return this.db.prepare(`
      ...
      `).run(c,o),{observationIds:l,summaryId:S,createdAtEpoch:c}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:r,project:o}=t,i=s==="date_asc"?"ASC":"DESC",a=r?`LIMIT ${r}`:"",d=e.map(()=>"?").join(","),p=[...e],c=o?`WHERE id IN (${d}) AND project = ?`:`WHERE id IN (${d})`;return o&&p.push(o),this.db.prepare(`
    ...
    `).all(...p)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:r,project:o}=t,i=s==="date_asc"?"ASC":"DESC",a=r?`LIMIT ${r}`:"",d=e.map(()=>"?").join(","),p=[...e],c=o?"AND s.project = ?":"";return o&&p.push(o),this.db.prepare(`
      ...
      ${a}
    `).all(...p)}getTimelineAroundTimestamp(e,t=10,s=10,r){return this.getTimelineAroundObservation(null,e,t,s,r)}getTimelineAroundObservation(e,t,s=10,r=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,p;if(e!==null){let u=`
      ...
      `,b=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let g=this.db.prepare(u).all(e,...a,s+1),f=this.db.prepare(b).all(e,...a,r+1);if(g.length===0&&f.length===0)return{observations:[],sessions:[],prompts:[]};d=g.length>0?g[g.length-1].created_at_epoch:t,p=f.length>0?f[f.length-1].created_at_epoch:t}catch(g){return _.error("DB","Error getting boundary observations",void 0,{error:g,project:o}),{observations:[],sessions:[],prompts:[]}}}else{let u=`
      ...
      `,b=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let g=this.db.prepare(u).all(t,...a,s),f=this.db.prepare(b).all(t,...a,r+1);if(g.length===0&&f.length===0)return{observations:[],sessions:[],prompts:[]};d=g.length>0?g[g.length-1].created_at_epoch:t,p=f.length>0?f[f.length-1].created_at_epoch:t}catch(g){return _.error("DB","Error getting boundary timestamps",void 0,{error:g,project:o}),{observations:[],sessions:[],prompts:[]}}}let c=`
      SELECT *
      FROM observations
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(e,...s,...o,a);return ne(d,t.totalObservationCount)}function re(n,e,t){return n.db.prepare(`
    SELECT id, memory_session_id, request, investigated, learned, completed, next_steps, created_at, created_at_epoch
    FROM session_summaries
    WHERE project = ?
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(e,t.sessionCount+Z)}function Ce(n,e,t){let s=Array.from(t.observationTypes),r=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(","),d=t.totalObservationCount*Ae,p=n.db.prepare(`
    SELECT
      id, memory_session_id, type, title, subtitle, narrative,
      facts, concepts, files_read, files_modified, discovery_tokens,
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(...e,...s,...o,d);return ne(p,t.totalObservationCount)}function Le(n,e,t){let s=e.map(()=>"?").join(",");return n.db.prepare(`
    SELECT id, memory_session_id, request, investigated, learned, completed, next_steps, created_at, created_at_epoch, project
    FROM session_summaries
    WHERE project IN (${s})
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(...e,t.sessionCount+Z)}function kt(n,e){let t=(e-n.created_at_epoch)/3600,s=Math.max(0,1-t/168),r=0;if(n.title&&n.title.trim().length>0&&(r+=.1),n.facts)try{let o=JSON.parse(n.facts);Array.isArray(o)&&(r+=Math.min(o.length*.1,.3))}catch{n.facts.trim().length>0&&(r+=.1)}if(n.concepts)try{let o=JSON.parse(n.concepts);Array.isArray(o)&&(r+=Math.min(o.length*.05,.2))}catch{n.concepts.trim().length>0&&(r+=.05)}if(n.narrative&&n.narrative.trim().length>0&&(r+=.1),n.files_modified)try{let o=JSON.parse(n.files_modified);Array.isArray(o)&&o.length>0&&(r+=.1)}catch{n.files_modified.trim().length>0&&(r+=.1)}return s+r}function ne(n,e){if(n.length<=e)return n;let t=Math.floor(Date.now()/1e3),s=n.map(o=>({obs:o,score:kt(o,t)}));s.sort((o,i)=>i.score-o.score);let r=s.slice(0,e).map(o=>o.obs);return r.sort((o,i)=>i.created_at_epoch-o.created_at_epoch),r}function wt(n){return n.replace(/\//g,"-")}function Xt(n){try{if(!(0,W.existsSync)(n))return{userMessage:"",assistantMessage:""};let e=(0,W.readFileSync)(n,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
`).filter(r=>r.trim()),s="";for(let r=t.length-1;r>=0;r--)try{let o=t[r];if(!o.includes('"type":"assistant"'))continue;let i=JSON.parse(o);if(i.type==="assistant"&&i.message?.content&&Array.isArray(i.message.content)){let a="";for(let d of i.message.content)d.type==="text"&&(a+=d.text);if(a=a.replace(/<system-reminder>[\s\S]*?<\/system-reminder>/g,"").trim(),a){s=a;break}}}catch(o){_.debug("PARSER","Skipping malformed transcript line",{lineIndex:r},o);continue}return{userMessage:"",assistantMessage:s}}catch(e){return _.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:n},e),{userMessage:"",assistantMessage:""}}}function oe(n,e,t,s){if(!e.showLastMessage||n.length===0)return{userMessage:"",assistantMessage:""};let r=n.find(d=>d.memory_session_id!==t);if(!r)return{userMessage:"",assistantMessage:""};let o=r.memory_session_id,i=wt(s),a=Oe.default.join(C,"projects",i,`${o}.jsonl`);return Xt(a)}function ve(n,e){let t=e[0]?.id;return n.map((s,r)=>{let o=r===0?null:e[r+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function ie(n,e){let t=[...n.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,r)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=r.type==="observation"?r.data.created_at_epoch:r.data.displayEpoch;return o-i}),t}function De(n,e){return new Set(n.slice(0,e).map(t=>t.id))}function ye(){let n=new Date,e=n.toLocaleDateString("en-CA"),t=n.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=n.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Me(n){return[`# $CMEM ${n} ${ye()}`,""]}function Ue(){return[`Legend: \u{1F3AF}session ${R.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function xe(){return[]}function ke(){return[]}function we(n,e){let t=[],s=[`${n.totalObservations} obs (${n.totalReadTokens.toLocaleString()}t read)`,`${n.totalDiscoveryTokens.toLocaleString()}t work`];return n.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${n.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${n.savings.toLocaleString()}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function Xe(n){return[`### ${n}`]}function Fe(n){return n.toLowerCase().replace(" am","a").replace(" pm","p")}function Pe(n,e,t){let s=n.title||"Untitled",r=R.getInstance().getTypeIcon(n.type),o=e?Fe(e):'"';return`${n.id} ${o} ${r} ${s}`}function Ge(n,e,t,s){let r=[],o=n.title||"Untitled",i=R.getInstance().getTypeIcon(n.type),a=e?Fe(e):'"',{readTokens:d,discoveryDisplay:p}=y(n,s);r.push(`**${n.id}** ${a} ${i} **${o}**`),t&&r.push(t);let c=[];return s.showReadTokens&&c.push(`~${d}t`),s.showWorkTokens&&c.push(p),c.length>0&&r.push(c.join(" ")),r.push(""),r}function $e(n,e){return[`S${n.id} ${n.request||"Session started"} (${e})`]}function M(n,e){return e?[`**${n}**: ${e}`,""]:[]}function Be(n){return n.assistantMessage?["","---","","**Previously**","",`A: ${n.assistantMessage}`,""]:[]}function je(n,e){return["",`Access ${Math.round(n/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function He(n){return`# $CMEM ${n} ${ye()}

No previous sessions found.`}function We(){let n=new Date,e=n.toLocaleDateString("en-CA"),t=n.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=n.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Ve(n){return["",`${E.bright}${E.cyan}[${n}] recent context, ${We()}${E.reset}`,`${E.gray}${"\u2500".repeat(60)}${E.reset}`,""]}function Ye(){let e=R.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${E.dim}Legend: session-request | ${e}${E.reset}`,""]}function qe(){return[`${E.bright}Column Key${E.reset}`,`${E.dim}  Read: Tokens to read this observation (cost to learn it now)${E.reset}`,`${E.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${E.reset}`,""]}function Ke(){return[`${E.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${E.reset}`,"",`${E.dim}When you need implementation details, rationale, or debugging context:${E.reset}`,`${E.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${E.reset}`,`${E.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${E.reset}`,`${E.dim}  - Trust this index over re-reading code for past decisions and learnings${E.reset}`,""]}function Je(n,e){let t=[];if(t.push(`${E.bright}${E.cyan}Context Economics${E.reset}`),t.push(`${E.dim}  Loading: ${n.totalObservations} observations (${n.totalReadTokens.toLocaleString()} tokens to read)${E.reset}`),t.push(`${E.dim}  Work investment: ${n.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${E.reset}`),n.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${n.savings.toLocaleString()} tokens (${n.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${n.savings.toLocaleString()} tokens`:s+=`${n.savingsPercent}% reduction from reuse`,t.push(`${E.green}${s}${E.reset}`)}return t.push(""),t}function Qe(n){return[`${E.bright}${E.cyan}${n}${E.reset}`,""]}function ze(n){return[`${E.dim}${n}${E.reset}`]}function Ze(n,e,t,s){let r=n.title||"Untitled",o=R.getInstance().getTypeIcon(n.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=y(n,s),p=t?`${E.dim}${e}${E.reset}`:" ".repeat(e.length),c=s.showReadTokens&&i>0?`${E.dim}(~${i}t)${E.reset}`:"",m=s.showWorkTokens&&a>0?`${E.dim}(${d} ${a.toLocaleString()}t)${E.reset}`:"";return`  ${E.dim}#${n.id}${E.reset}  ${p}  ${o}  ${r} ${c} ${m}`}function et(n,e,t,s,r){let o=[],i=n.title||"Untitled",a=R.getInstance().getTypeIcon(n.type),{readTokens:d,discoveryTokens:p,workEmoji:c}=y(n,r),m=t?`${E.dim}${e}${E.reset}`:" ".repeat(e.length),T=r.showReadTokens&&d>0?`${E.dim}(~${d}t)${E.reset}`:"",l=r.showWorkTokens&&p>0?`${E.dim}(${c} ${p.toLocaleString()}t)${E.reset}`:"";return o.push(`  ${E.dim}#${n.id}${E.reset}  ${m}  ${a}  ${E.bright}${i}${E.reset}`),s&&o.push(`    ${E.dim}${s}${E.reset}`),(T||l)&&o.push(`    ${T} ${l}`),o.push(""),o}function tt(n,e){let t=`${n.request||"Session started"} (${e})`;return[`${E.yellow}#S${n.id}${E.reset} ${t}`,""]}function U(n,e,t){return e?[`${t}${n}:${E.reset} ${e}`,""]:[]}function st(n){return n.assistantMessage?["","---","",`${E.bright}${E.magenta}Previously${E.reset}`,"",`${E.dim}A: ${n.assistantMessage}${E.reset}`,""]:[]}function rt(n,e){let t=Math.round(n/1e3);return["",`${E.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the mem-search skill to access memories by ID.${E.reset}`]}function nt(n){return`
${E.bright}${E.cyan}[${n}] recent context, ${We()}${E.reset}
${E.gray}${"\u2500".repeat(60)}${E.reset}

${E.dim}No previous sessions found for this project yet.${E.reset}
`}function ot(n,e,t,s){let r=[];return s?r.push(...Ve(n)):r.push(...Me(n)),s?r.push(...Ye()):r.push(...Ue()),s?r.push(...qe()):r.push(...xe()),s?r.push(...Ke()):r.push(...ke()),H(t)&&(s?r.push(...Je(e,t)):r.push(...we(e,t))),r}var ae=k(require("path"),1);function q(n){if(!n)return[];try{let e=JSON.parse(n);return Array.isArray(e)?e:[]}catch(e){return _.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:n?.substring(0,50)},e),[]}}function de(n){return new Date(n).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function _e(n){return new Date(n).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function at(n){return new Date(n).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function it(n,e){return ae.default.isAbsolute(n)?ae.default.relative(e,n):n}function dt(n,e,t){let s=q(n);if(s.length>0)return it(s[0],e);if(t){let r=q(t);if(r.length>0)return it(r[0],e)}return"General"}function Ft(n){let e=new Map;for(let s of n){let r=s.type==="observation"?s.data.created_at:s.data.displayTime,o=at(r);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,r)=>{let o=new Date(s[0]).getTime(),i=new Date(r[0]).getTime();return o-i});return new Map(t)}function _t(n,e){return e.fullObservationField==="narrative"?n.narrative:n.facts?q(n.facts).join(`
`):null}function Pt(n,e,t,s){let r=[];r.push(...Xe(n));let o="";for(let i of e)if(i.type==="summary"){o="";let a=i.data,d=de(a.displayTime);r.push(...$e(a,d))}else{let a=i.data,d=_e(a.created_at),c=d!==o?d:"";if(o=d,t.has(a.id)){let T=_t(a,s);r.push(...Ge(a,c,T,s))}else r.push(Pe(a,c,s))}return r}function Gt(n,e,t,s,r){let o=[];o.push(...Qe(n));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let p=d.data,c=de(p.displayTime);o.push(...tt(p,c))}else{let p=d.data,c=dt(p.files_modified,r,p.files_read),m=_e(p.created_at),T=m!==a;a=m;let l=t.has(p.id);if(c!==i&&(o.push(...ze(c)),i=c),l){let h=_t(p,s);o.push(...et(p,m,T,h,s))}else o.push(Ze(p,m,T,s))}return o.push(""),o}function $t(n,e,t,s,r,o){return o?Gt(n,e,t,s,r):Pt(n,e,t,s)}function Et(n,e,t,s,r){let o=[],i=Ft(n);for(let[a,d]of i)o.push(...$t(a,d,e,t,s,r));return o}function pt(n,e,t){return!(!n.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function ct(n,e){let t=[];return e?(t.push(...U("Investigated",n.investigated,E.blue)),t.push(...U("Learned",n.learned,E.yellow)),t.push(...U("Completed",n.completed,E.green)),t.push(...U("Next Steps",n.next_steps,E.magenta))):(t.push(...M("Investigated",n.investigated)),t.push(...M("Learned",n.learned)),t.push(...M("Completed",n.completed)),t.push(...M("Next Steps",n.next_steps))),t}function ut(n,e){return e?st(n):Be(n)}function mt(n,e,t){return!H(e)||n.totalDiscoveryTokens<=0||n.savings<=0?[]:t?rt(n.totalDiscoveryTokens,n.totalReadTokens):je(n.totalDiscoveryTokens,n.totalReadTokens)}function lt(n,e){if(!n)return[];let t=n.agent_soul,s=n.user;if(!t?.name&&!t?.vibe&&!s?.name)return[];let r=[];return r.push("<agent-identity>"),t?.name&&r.push(`You are ${t.name}.`),t?.self_description&&r.push(t.self_description),t?.vibe&&r.push(`Style: ${t.vibe}`),t?.running_environment&&r.push(`Running on: ${t.running_environment}`),s?.name&&(r.push(""),r.push(`User: ${s.name}`),s.role&&r.push(`Role: ${s.role}`),s.language&&r.push(`Language: ${s.language}`)),n.style?.tone&&(r.push(""),r.push(`Communication: ${n.style.tone}`)),r.push("</agent-identity>"),r.push(""),r}function Tt(n,e){if(!n)return[];let t=[];if(t.push("<active-task>"),n.status==="blocked"?(t.push(`**Blocked Task**: ${n.task_name}`),n.progress&&t.push(`Progress: ${n.progress}`),n.next_step&&t.push(`Blocker: ${n.next_step}`)):(t.push(`**Active Task**: ${n.task_name}`),n.progress&&t.push(`Progress: ${n.progress}`),n.next_step&&t.push(`Next: ${n.next_step}`)),n.interrupted_tasks_json)try{let s=JSON.parse(n.interrupted_tasks_json);if(Array.isArray(s)&&s.length>0){t.push(""),t.push("Interrupted tasks:");for(let r of s)t.push(`- ${r.task_name||r.name} (paused at: ${r.progress||"unknown"})`)}}catch{}return t.push("</active-task>"),t.push(""),t}var K=class{constructor(e){this.db=e}getProfile(e,t){let s=this.db.prepare("SELECT content_json FROM agent_profiles WHERE scope = ? AND profile_type = ?").get(e,t);if(!s)return null;try{return JSON.parse(s.content_json)}catch{return null}}setProfile(e,t,s){let r=new Date().toISOString(),o=Date.now(),i=JSON.stringify(s);this.db.prepare(`
...
`):s}function Wt(n,e,t,s,r,o,i,a,d){let p=[];if(a&&p.push(...lt(a,i)),d&&p.push(...Tt(d,i)),!d&&t.length>0&&t[0].next_steps){let g=t[0].next_steps.trim();g&&(i?p.push(`\x1B[33m\u25C6 Last session's next steps:\x1B[0m ${g}`,""):p.push(`**Last session's next steps:** ${g}`,""))}let c=te(e);p.push(...ot(n,c,s,i));let m=t.slice(0,s.sessionCount),T=ve(m,t),l=ie(e,T),h=De(e,s.fullObservationCount);p.push(...Et(l,h,s,r,i));let S=t[0],u=e[0];pt(s,S,u)&&p.push(...ct(S,i));let b=oe(e,s,o,r);return p.push(...ut(b,i)),p.push(...mt(c,s,i)),p.join(`
`).trimEnd()}async function Ee(n,e=!1){let t=z(),s=n?.cwd??process.cwd(),r=fe(s),o=n?.projects||[r];n?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let i=jt();if(!i)return"";try{let a=o.length>1?Ce(i,o,t):se(i,r,t),d=o.length>1?Le(i,o,t):re(i,r,t),p=null,c=null,m=null;try{let l=new K(i.db);p=l.getMergedPersona(r),c=l.getActiveTask(r),m=l.getBootstrapStatus("__global__")}catch(l){_.debug("CONTEXT","Persona query skipped (tables may not exist yet)",{},l)}return a.length===0&&d.length===0&&!p?.agent_soul?.name?Ht(r,e,m):Wt(r,a,d,t,s,n?.session_id,e,p,c)}finally{i.close()}}0&&(module.exports={generateContext});
