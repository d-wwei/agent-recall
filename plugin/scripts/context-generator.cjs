"use strict";var Wt=Object.create;var J=Object.defineProperty;var Yt=Object.getOwnPropertyDescriptor;var Vt=Object.getOwnPropertyNames;var qt=Object.getPrototypeOf,Kt=Object.prototype.hasOwnProperty;var Jt=(r,e)=>{for(var t in e)J(r,t,{get:e[t],enumerable:!0})},xe=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Vt(e))!Kt.call(r,n)&&n!==t&&J(r,n,{get:()=>e[n],enumerable:!(s=Yt(e,n))||s.enumerable});return r};var $=(r,e,t)=>(t=r!=null?Wt(qt(r)):{},xe(e||!r||!r.__esModule?J(t,"default",{value:r,enumerable:!0}):t,r)),Qt=r=>xe(J({},"__esModule",{value:!0}),r);var As={};Jt(As,{generateContext:()=>Ue});module.exports=Qt(As);var ue=$(require("path"),1),me=require("os"),Ht=require("fs");var He=require("bun:sqlite");var S=require("path"),Q=require("os"),j=require("fs");var Xe=require("url");var y=require("fs"),B=require("path"),Fe=require("os"),Te=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Te||{}),we=(0,B.join)((0,Fe.homedir)(),".agent-recall"),ge=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,B.join)(we,"logs");(0,y.existsSync)(e)||(0,y.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,B.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,B.join)(we,"settings.json");if((0,y.existsSync)(e)){let t=(0,y.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Te[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=Te[e].padEnd(5),d=t.padEnd(6),E="";n?.correlationId?E=`[${n.correlationId}] `:n?.sessionId&&(E=`[session-${n.sessionId}] `);let p="";o!=null&&(o instanceof Error?p=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`:this.getLevel()===0&&typeof o=="object"?p=`
`+JSON.stringify(o,null,2):p=" "+this.formatData(o));let _="";if(n){let{sessionId:m,memorySessionId:g,correlationId:R,...T}=n;Object.keys(T).length>0&&(_=` {${Object.entries(T).map(([b,N])=>`${b}=${N}`).join(", ")}}`)}let u=`[${i}] [${a}] [${d}] ${E}${s}${_}${p}`;if(this.logFilePath)try{(0,y.appendFileSync)(this.logFilePath,u+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),p=E?`${E[1].split("/").pop()}:${E[2]}`:"unknown",_={...s,location:p};return this.warn(e,`[HAPPY-PATH] ${t}`,_,n),o}},c=new ge;var ss={};function zt(){return typeof __dirname<"u"?__dirname:(0,S.dirname)((0,Xe.fileURLToPath)(ss.url))}var Zt=zt(),es=(0,S.join)((0,Q.homedir)(),".claude-mem");function ts(){if(process.env.AGENT_RECALL_DATA_DIR)return process.env.AGENT_RECALL_DATA_DIR;if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,S.join)((0,Q.homedir)(),".agent-recall"),e=(0,S.join)(r,"settings.json");try{if((0,j.existsSync)(e)){let{readFileSync:s}=require("fs"),n=JSON.parse(s(e,"utf-8")),o=n.env??n;if(o.AGENT_RECALL_DATA_DIR||o.CLAUDE_MEM_DATA_DIR)return o.AGENT_RECALL_DATA_DIR||o.CLAUDE_MEM_DATA_DIR}}catch{}let t=(0,S.join)(es,"settings.json");try{if((0,j.existsSync)(t)){let{readFileSync:s}=require("fs"),n=JSON.parse(s(t,"utf-8")),o=n.env??n;if(o.CLAUDE_MEM_DATA_DIR)return o.CLAUDE_MEM_DATA_DIR}}catch{}return r}var v=ts(),k=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,Q.homedir)(),".claude"),ys=(0,S.join)(k,"plugins","marketplaces","agent-recall"),Ms=(0,S.join)(k,"plugins","marketplaces","thedotmack"),Us=(0,S.join)(v,"archives"),ks=(0,S.join)(v,"logs"),xs=(0,S.join)(v,"trash"),ws=(0,S.join)(v,"backups"),Fs=(0,S.join)(v,"modes"),Pe=(0,S.join)(v,"settings.json"),Ge=(0,S.join)(v,"agent-recall.db");var Xs=(0,S.join)(v,"vector-db"),Ps=(0,S.join)(v,"observer-sessions"),Gs=(0,S.join)(k,"settings.json"),$s=(0,S.join)(k,"commands"),Bs=(0,S.join)(k,"CLAUDE.md");function $e(r){(0,j.mkdirSync)(r,{recursive:!0})}function Be(){return(0,S.join)(Zt,"..")}var je=require("crypto");var ns=3e4;function z(r,e,t){return(0,je.createHash)("sha256").update((r||"")+(e||"")+(t||"")).digest("hex").slice(0,16)}function Z(r,e,t){let s=t-ns;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}var ee=class{constructor(e){this.db=e}runAllMigrations(){this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.createAgentRecallCoreTables(),this.addScopeColumns(),this.createSessionArchivesTable(),this.createTemplatesTable(),this.createAuditLogTable(),this.createObservationBufferTable(),this.addObservationPhase1Fields(),this.createSyncStateTable(),this.createCompiledKnowledgeTable(),this.addObservationPhase2Fields(),this.createEntitiesTable(),this.createFactsTable(),this.createAgentDiaryTable(),this.createMarkdownSyncTable(),this.createActivityLogTable(),this.addSessionPrivacyColumn(),this.addObservationPropagatedColumn(),this.createSharedKnowledgeTable(),this.createCompilationLogsTable()}initializeSchema(){this.db.run(`
    ...
    `),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(38,new Date().toISOString()),c.debug("DB","activity_log table created successfully"))}addSessionPrivacyColumn(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(39))return;this.db.prepare("PRAGMA table_info(sdk_sessions)").all().some(n=>n.name==="has_private_content")||this.db.exec("ALTER TABLE sdk_sessions ADD COLUMN has_private_content INTEGER DEFAULT 0"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(39,new Date().toISOString()),c.debug("DB","has_private_content column added to sdk_sessions")}addObservationPropagatedColumn(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(40))return;this.db.prepare("PRAGMA table_info(observations)").all().some(n=>n.name==="propagated")||this.db.exec("ALTER TABLE observations ADD COLUMN propagated INTEGER DEFAULT 0"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(40,new Date().toISOString()),c.debug("DB","propagated column added to observations")}createSharedKnowledgeTable(){this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(41)||(this.db.exec(`
    ...
    `),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(41,new Date().toISOString()),c.debug("DB","shared_knowledge table created"))}createCompilationLogsTable(){this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(42)||(this.db.exec(`
    ...
    `),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(42,new Date().toISOString()),c.debug("DB","compilation_logs table created"))}};var te=class{db;constructor(e=Ge){e!==":memory:"&&$e(v),this.db=new He.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),new ee(this.db).runAllMigrations()}initializeSchema(){this.db.run(`
      CREATE TABLE IF NOT EXISTS schema_versions (
        id INTEGER PRIMARY KEY,
        version INTEGER UNIQUE NOT NULL,
        applied_at TEXT NOT NULL
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,E=s==="date_asc"?"ASC":"DESC",p=n?`LIMIT ${n}`:"",_=e.map(()=>"?").join(","),u=[...e],m=[];if(o&&(m.push("project = ?"),u.push(o)),i)if(Array.isArray(i)){let T=i.map(()=>"?").join(",");m.push(`type IN (${T})`),u.push(...i)}else m.push("type = ?"),u.push(i);if(a){let T=Array.isArray(a)?a:[a],h=T.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");u.push(...T),m.push(`(${h.join(" OR ")})`)}if(d){let T=Array.isArray(d)?d:[d],h=T.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");T.forEach(b=>{u.push(`%${b}%`,`%${b}%`)}),m.push(`(${h.join(" OR ")})`)}let g=m.length>0?`WHERE id IN (${_}) AND ${m.join(" AND ")}`:`WHERE id IN (${_})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${g}
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),E=z(e,s.title,s.narrative),p=Z(this.db,E,a);if(p)return{id:p.id,createdAtEpoch:p.created_at_epoch};let u=this.db.prepare(`
      INSERT INTO observations
      (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
       files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
       confidence, tags, has_preference, event_date)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,E,d,a,s.confidence||"medium",JSON.stringify(s.tags||[]),s.has_preference?1:0,s.event_date||null);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),p=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(p.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a){let d=a??Date.now(),E=new Date(d).toISOString();return this.db.transaction(()=>{let _=[],u=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         confidence, tags, has_preference, event_date)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let g of s){let R=z(e,g.title,g.narrative),T=Z(this.db,R,d);if(T){_.push(T.id);continue}let h=u.run(e,t,g.type,g.title,g.subtitle,JSON.stringify(g.facts),g.narrative,JSON.stringify(g.concepts),JSON.stringify(g.files_read),JSON.stringify(g.files_modified),o||null,i,R,E,d,g.confidence||"medium",JSON.stringify(g.tags||[]),g.has_preference?1:0,g.event_date||null);_.push(Number(h.lastInsertRowid))}let m=null;if(n){let R=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,E,d);m=Number(R.lastInsertRowid)}return{observationIds:_,summaryId:m,createdAtEpoch:d}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,E){let p=E??Date.now(),_=new Date(p).toISOString();return this.db.transaction(()=>{let m=[],g=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         confidence, tags, has_preference, event_date)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let h of s){let b=z(e,h.title,h.narrative),N=Z(this.db,b,p);if(N){m.push(N.id);continue}let C=g.run(e,t,h.type,h.title,h.subtitle,JSON.stringify(h.facts),h.narrative,JSON.stringify(h.concepts),JSON.stringify(h.files_read),JSON.stringify(h.files_modified),a||null,d,b,_,p,h.confidence||"medium",JSON.stringify(h.tags||[]),h.has_preference?1:0,h.event_date||null);m.push(Number(C.lastInsertRowid))}let R;if(n){let b=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,_,p);R=Number(b.lastInsertRowid)}return this.db.prepare(`
      ...
      `).run(p,o),{observationIds:m,summaryId:R,createdAtEpoch:p}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="date_asc"?"ASC":"DESC",a=n?`LIMIT ${n}`:"",d=e.map(()=>"?").join(","),E=[...e],p=o?`WHERE id IN (${d}) AND project = ?`:`WHERE id IN (${d})`;return o&&E.push(o),this.db.prepare(`
    ...
    `).all(...E)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,E;if(e!==null){let T=`
      ...
      `,h=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let b=this.db.prepare(T).all(e,...a,s+1),N=this.db.prepare(h).all(e,...a,n+1);if(b.length===0&&N.length===0)return{observations:[],sessions:[],prompts:[]};d=b.length>0?b[b.length-1].created_at_epoch:t,E=N.length>0?N[N.length-1].created_at_epoch:t}catch(b){return c.error("DB","Error getting boundary observations",void 0,{error:b,project:o}),{observations:[],sessions:[],prompts:[]}}}else{let T=`
      ...
      `,h=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let b=this.db.prepare(T).all(t,...a,s),N=this.db.prepare(h).all(t,...a,n+1);if(b.length===0&&N.length===0)return{observations:[],sessions:[],prompts:[]};d=b.length>0?b[b.length-1].created_at_epoch:t,E=N.length>0?N[N.length-1].created_at_epoch:t}catch(b){return c.error("DB","Error getting boundary timestamps",void 0,{error:b,project:o}),{observations:[],sessions:[],prompts:[]}}}let p=`
      SELECT *
      FROM observations
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(e,...s,...o,a);return Oe(d,t.totalObservationCount)}function Re(r,e,t){return r.db.prepare(`
    SELECT id, memory_session_id, request, investigated, learned, completed, next_steps, created_at, created_at_epoch
    FROM session_summaries
    WHERE project = ?
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(e,t.sessionCount+fe)}function Qe(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(","),d=t.totalObservationCount*Je,E=r.db.prepare(`
    SELECT
      id, memory_session_id, type, title, subtitle, narrative,
      facts, concepts, files_read, files_modified, discovery_tokens,
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(...e,...s,...o,d);return Oe(E,t.totalObservationCount)}function ze(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT id, memory_session_id, request, investigated, learned, completed, next_steps, created_at, created_at_epoch, project
    FROM session_summaries
    WHERE project IN (${s})
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(...e,t.sessionCount+fe)}function os(r,e){let t=(e-r.created_at_epoch)/3600,s=Math.max(0,1-t/168),n=0;if(r.title&&r.title.trim().length>0&&(n+=.1),r.facts)try{let o=JSON.parse(r.facts);Array.isArray(o)&&(n+=Math.min(o.length*.1,.3))}catch{r.facts.trim().length>0&&(n+=.1)}if(r.concepts)try{let o=JSON.parse(r.concepts);Array.isArray(o)&&(n+=Math.min(o.length*.05,.2))}catch{r.concepts.trim().length>0&&(n+=.05)}if(r.narrative&&r.narrative.trim().length>0&&(n+=.1),r.files_modified)try{let o=JSON.parse(r.files_modified);Array.isArray(o)&&o.length>0&&(n+=.1)}catch{r.files_modified.trim().length>0&&(n+=.1)}return s+n}function Oe(r,e){if(r.length<=e)return r;let t=Math.floor(Date.now()/1e3),s=r.map(o=>({obs:o,score:os(o,t)}));s.sort((o,i)=>i.score-o.score);let n=s.slice(0,e).map(o=>o.obs);return n.sort((o,i)=>i.created_at_epoch-o.created_at_epoch),n}function is(r){return r.replace(/\//g,"-")}function as(r){try{if(!(0,ae.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,ae.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim()),s="";for(let n=t.length-1;n>=0;n--)try{let o=t[n];if(!o.includes('"type":"assistant"'))continue;let i=JSON.parse(o);if(i.type==="assistant"&&i.message?.content&&Array.isArray(i.message.content)){let a="";for(let d of i.message.content)d.type==="text"&&(a+=d.text);if(a=a.replace(/<system-reminder>[\s\S]*?<\/system-reminder>/g,"").trim(),a){s=a;break}}}catch(o){c.debug("PARSER","Skipping malformed transcript line",{lineIndex:n},o);continue}return{userMessage:"",assistantMessage:s}}catch(e){return c.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e),{userMessage:"",assistantMessage:""}}}function Ie(r,e,t,s){if(!e.showLastMessage||r.length===0)return{userMessage:"",assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{userMessage:"",assistantMessage:""};let o=n.memory_session_id,i=is(s),a=Ke.default.join(k,"projects",i,`${o}.jsonl`);return as(a)}function Ze(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function Ae(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function et(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function tt(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function st(r){return[`# $CMEM ${r} ${tt()}`,""]}function nt(){return[`Legend: \u{1F3AF}session ${A.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function rt(){return[]}function ot(){return[]}function it(r,e){let t=[],s=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString()}t read)`,`${r.totalDiscoveryTokens.toLocaleString()}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${r.savings.toLocaleString()}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function at(r){return[`### ${r}`]}function dt(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function ct(r,e,t){let s=r.title||"Untitled",n=A.getInstance().getTypeIcon(r.type),o=e?dt(e):'"';return`${r.id} ${o} ${n} ${s}`}function pt(r,e,t,s){let n=[],o=r.title||"Untitled",i=A.getInstance().getTypeIcon(r.type),a=e?dt(e):'"',{readTokens:d,discoveryDisplay:E}=W(r,s);n.push(`**${r.id}** ${a} ${i} **${o}**`),t&&n.push(t);let p=[];return s.showReadTokens&&p.push(`~${d}t`),s.showWorkTokens&&p.push(E),p.length>0&&n.push(p.join(" ")),n.push(""),n}function Et(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}function Y(r,e){return e?[`**${r}**: ${e}`,""]:[]}function lt(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function _t(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function ut(r){return`# $CMEM ${r} ${tt()}

No previous sessions found.`}function mt(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Tt(r){return["",`${l.bright}${l.cyan}[${r}] recent context, ${mt()}${l.reset}`,`${l.gray}${"\u2500".repeat(60)}${l.reset}`,""]}function gt(){let e=A.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${l.dim}Legend: session-request | ${e}${l.reset}`,""]}function ht(){return[`${l.bright}Column Key${l.reset}`,`${l.dim}  Read: Tokens to read this observation (cost to learn it now)${l.reset}`,`${l.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${l.reset}`,""]}function ft(){return[`${l.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${l.reset}`,"",`${l.dim}When you need implementation details, rationale, or debugging context:${l.reset}`,`${l.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${l.reset}`,`${l.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${l.reset}`,`${l.dim}  - Trust this index over re-reading code for past decisions and learnings${l.reset}`,""]}function Nt(r,e){let t=[];if(t.push(`${l.bright}${l.cyan}Context Economics${l.reset}`),t.push(`${l.dim}  Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)${l.reset}`),t.push(`${l.dim}  Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${l.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(`${l.green}${s}${l.reset}`)}return t.push(""),t}function bt(r){return[`${l.bright}${l.cyan}${r}${l.reset}`,""]}function St(r){return[`${l.dim}${r}${l.reset}`]}function Rt(r,e,t,s){let n=r.title||"Untitled",o=A.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=W(r,s),E=t?`${l.dim}${e}${l.reset}`:" ".repeat(e.length),p=s.showReadTokens&&i>0?`${l.dim}(~${i}t)${l.reset}`:"",_=s.showWorkTokens&&a>0?`${l.dim}(${d} ${a.toLocaleString()}t)${l.reset}`:"";return`  ${l.dim}#${r.id}${l.reset}  ${E}  ${o}  ${n} ${p} ${_}`}function Ot(r,e,t,s,n){let o=[],i=r.title||"Untitled",a=A.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:E,workEmoji:p}=W(r,n),_=t?`${l.dim}${e}${l.reset}`:" ".repeat(e.length),u=n.showReadTokens&&d>0?`${l.dim}(~${d}t)${l.reset}`:"",m=n.showWorkTokens&&E>0?`${l.dim}(${p} ${E.toLocaleString()}t)${l.reset}`:"";return o.push(`  ${l.dim}#${r.id}${l.reset}  ${_}  ${a}  ${l.bright}${i}${l.reset}`),s&&o.push(`    ${l.dim}${s}${l.reset}`),(u||m)&&o.push(`    ${u} ${m}`),o.push(""),o}function It(r,e){let t=`${r.request||"Session started"} (${e})`;return[`${l.yellow}#S${r.id}${l.reset} ${t}`,""]}function V(r,e,t){return e?[`${t}${r}:${l.reset} ${e}`,""]:[]}function At(r){return r.assistantMessage?["","---","",`${l.bright}${l.magenta}Previously${l.reset}`,"",`${l.dim}A: ${r.assistantMessage}${l.reset}`,""]:[]}function Lt(r,e){let t=Math.round(r/1e3);return["",`${l.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the mem-search skill to access memories by ID.${l.reset}`]}function vt(r){return`
${l.bright}${l.cyan}[${r}] recent context, ${mt()}${l.reset}
${l.gray}${"\u2500".repeat(60)}${l.reset}

${l.dim}No previous sessions found for this project yet.${l.reset}
`}function Ct(r,e,t,s){let n=[];return s?n.push(...Tt(r)):n.push(...st(r)),s?n.push(...gt()):n.push(...nt()),s?n.push(...ht()):n.push(...rt()),s?n.push(...ft()):n.push(...ot()),ie(t)&&(s?n.push(...Nt(e,t)):n.push(...it(e,t))),n}var Le=$(require("path"),1);function w(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return c.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function ve(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Ce(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function yt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Dt(r,e){return Le.default.isAbsolute(r)?Le.default.relative(e,r):r}function Mt(r,e,t){let s=w(r);if(s.length>0)return Dt(s[0],e);if(t){let n=w(t);if(n.length>0)return Dt(n[0],e)}return"General"}function ds(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=yt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Ut(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?w(r.facts).join(`
`):null}function cs(r,e,t,s,n=!1){let o=[];o.push(...at(r));let i="";for(let a of e)if(a.type==="summary"){i="";let d=a.data,E=ve(d.displayTime);o.push(...Et(d,E))}else{let d=a.data,E=Ce(d.created_at),_=E!==i?E:"";if(i=E,n){let m=d.facts&&w(d.facts)[0]||"";o.push(`- [${d.type}] ${d.title}${m?": "+m:""}`);continue}if(t.has(d.id)){let m=Ut(d,s);o.push(...pt(d,_,m,s))}else o.push(ct(d,_,s))}return o}function ps(r,e,t,s,n,o=!1){let i=[];i.push(...bt(r));let a=null,d="";for(let E of e)if(E.type==="summary"){a=null,d="";let p=E.data,_=ve(p.displayTime);i.push(...It(p,_))}else{let p=E.data,_=Mt(p.files_modified,n,p.files_read),u=Ce(p.created_at),m=u!==d;if(d=u,o){let R=p.facts&&w(p.facts)[0]||"";i.push(`- [${p.type}] ${p.title}${R?": "+R:""}`);continue}let g=t.has(p.id);if(_!==a&&(i.push(...St(_)),a=_),g){let R=Ut(p,s);i.push(...Ot(p,u,m,R,s))}else i.push(Rt(p,u,m,s))}return i.push(""),i}function Es(r,e,t,s,n,o,i=!1){return o?ps(r,e,t,s,n,i):cs(r,e,t,s,i)}function kt(r,e,t,s,n,o=!1){let i=[],a=ds(r);for(let[d,E]of a)i.push(...Es(d,E,e,t,s,n,o));return i}function xt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function wt(r,e){let t=[];return e?(t.push(...V("Investigated",r.investigated,l.blue)),t.push(...V("Learned",r.learned,l.yellow)),t.push(...V("Completed",r.completed,l.green)),t.push(...V("Next Steps",r.next_steps,l.magenta))):(t.push(...Y("Investigated",r.investigated)),t.push(...Y("Learned",r.learned)),t.push(...Y("Completed",r.completed)),t.push(...Y("Next Steps",r.next_steps))),t}function Ft(r,e){return e?At(r):lt(r)}function Xt(r,e,t){return!ie(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Lt(r.totalDiscoveryTokens,r.totalReadTokens):_t(r.totalDiscoveryTokens,r.totalReadTokens)}function De(r,e){if(!r)return[];let t=r.agent_soul,s=r.user;if(!t?.name&&!t?.vibe&&!s?.name)return[];let n=[];return n.push("<agent-identity>"),t?.name&&n.push(`You are ${t.name}.`),t?.self_description&&n.push(t.self_description),t?.vibe&&n.push(`Style: ${t.vibe}`),t?.running_environment&&n.push(`Running on: ${t.running_environment}`),s?.name&&(n.push(""),n.push(`User: ${s.name}`),s.role&&n.push(`Role: ${s.role}`),s.language&&n.push(`Language: ${s.language}`)),r.style?.tone&&(n.push(""),n.push(`Communication: ${r.style.tone}`)),n.push("</agent-identity>"),n.push(""),n}function ls(r){if(!r||r.length===0)return[];let e=[],t=r.filter(i=>i.status==="completed").length,s=r.length,n=r.find(i=>i.status==="in_progress"),o=n?n.name:"All complete";e.push(`Progress: Step ${n?t+1:t}/${s} \u2014 ${o}`);for(let i of r)i.status==="completed"?e.push(`[x] ${i.name}`):i.status==="in_progress"?e.push(`[>] ${i.name}  \u2190 current`):e.push(`[ ] ${i.name}`);return e}function ye(r,e){if(!r)return[];let t=[];t.push("<active-task>"),r.status==="blocked"?(t.push(`**Blocked Task**: ${r.task_name}`),r.progress&&t.push(`Progress: ${r.progress}`),r.next_step&&t.push(`Blocker: ${r.next_step}`)):t.push(`**Active Task**: ${r.task_name}`);let s=!1;if(r.context_json)try{let n=JSON.parse(r.context_json);Array.isArray(n.checkpoints)&&n.checkpoints.length>0&&(s=!0,t.push(...ls(n.checkpoints)))}catch{}if(!s&&r.status!=="blocked"&&(r.progress&&t.push(`Progress: ${r.progress}`),r.next_step&&t.push(`Next: ${r.next_step}`)),r.interrupted_tasks_json)try{let n=JSON.parse(r.interrupted_tasks_json);if(Array.isArray(n)&&n.length>0){t.push(""),t.push("Interrupted tasks:");for(let o of n)t.push(`- ${o.task_name||o.name} (paused at: ${o.progress||"unknown"})`)}}catch{}return t.push("</active-task>"),t.push(""),t}function Pt(r){let e="## Memory Protocol";return[r?`\x1B[1;36m${e}\x1B[0m`:e,"1. Before answering about past facts, search memory to verify \u2014 do not guess","2. When you discover information contradicting stored memory, flag it and request an update","3. User preferences, decisions, and corrections are worth recording",""]}var _s={L0:.08,L1:.15,L2:.6,L3:.17},pe=["L0","L1","L2","L3"],us=3e3,ms=1500,Ts=8e3,L=class{totalBudget;allocations;consumed;constructor(e=us){this.totalBudget=Math.min(Math.max(e,ms),Ts);let t={},s=0;for(let o=0;o<pe.length-1;o++){let i=pe[o];t[i]=Math.floor(this.totalBudget*_s[i]),s+=t[i]}let n=pe[pe.length-1];t[n]=this.totalBudget-s,this.allocations=t,this.consumed={L0:0,L1:0,L2:0,L3:0}}getBudget(e){return this.allocations[e]}remaining(e){return this.allocations[e]-this.consumed[e]}canFit(e,t){return t<=this.remaining(e)}consume(e,t){this.consumed[e]+=t}static estimateTokens(e){return!e||e.length===0?0:Math.ceil(e.length/4)}};var Gt={agent_soul:[{field:"name",required:!0},{field:"self_description",required:!1},{field:"core_values",required:!1},{field:"vibe",required:!1}],user:[{field:"name",required:!0},{field:"role",required:!0},{field:"language",required:!1},{field:"timezone",required:!1},{field:"profession",required:!1}],style:[{field:"tone",required:!0},{field:"brevity",required:!1},{field:"formatting",required:!1},{field:"output_structure",required:!1}],workflow:[{field:"preferred_role",required:!0},{field:"decision_style",required:!1},{field:"recurring_tasks",required:!1}]},gs=Object.keys(Gt),hs=90;function fs(r){return r==null?!0:Object.keys(r).length===0}function Ns(r,e){if(!r)return!1;let t=r[e];return!(t==null||t===""||Array.isArray(t)&&t.length===0)}var q=class{check(e){let t=0,s=0,n=[],o=[];for(let a of gs){let d=e[a],E=Gt[a];if(s+=E.length,fs(d)){n.push(a);for(let p of E)p.required&&o.push(`${a}.${p.field}`);continue}for(let p of E)Ns(d,p.field)?t++:p.required&&o.push(`${a}.${p.field}`)}return{percentage:s===0?0:Math.round(t/s*100),gaps:n,missingFields:o}}checkStaleness(e,t=new Date){let s=[],n=hs*24*60*60*1e3;for(let[o,i]of Object.entries(e)){if(!i)continue;let a=new Date(i);if(isNaN(a.getTime()))continue;t.getTime()-a.getTime()>n&&s.push(o)}return{staleFields:s}}};var K=class{constructor(e){this.db=e}getProfile(e,t){let s=this.db.prepare("SELECT content_json FROM agent_profiles WHERE scope = ? AND profile_type = ?").get(e,t);if(!s)return null;try{return JSON.parse(s.content_json)}catch{return null}}setProfile(e,t,s){let n=new Date().toISOString(),o=Date.now(),i=JSON.stringify(s);this.db.prepare(`
    ...
    `).run(e,t,i,n,o,n,o),c.debug("PERSONA",`Set ${t} profile for scope: ${e}`)}getMergedPersona(e){let t=["agent_soul","user","style","workflow"],s={};for(let n of t){let o=this.getProfile("global",n)||{},i=e?this.getProfile(e,n)||{}:{};s[n]={...o};for(let[a,d]of Object.entries(i))d!=null&&d!==""&&(s[n][a]=d)}return s}detectConflicts(e){if(!e)return[];let t=["user","style","workflow"],s=[];for(let n of t){let o=this.getProfile("global",n),i=this.getProfile(e,n);if(!(!o||!i))for(let a of Object.keys(i)){let d=o[a],E=i[a];d==null||d===""||E==null||E===""||JSON.stringify(d)!==JSON.stringify(E)&&s.push({profile_type:n,field:a,global_value:d,project_value:E})}}return s}resolveConflict(e,t,s,n,o){let i=this.getProfile("global",t)||{},a=this.getProfile(e,t)||{};switch(n){case"keep_global":{delete a[s],this.setProfile(e,t,a);break}case"keep_project":{i[s]=a[s],this.setProfile("global",t,i);break}case"custom":{i[s]=o,a[s]=o,this.setProfile("global",t,i),this.setProfile(e,t,a);break}}c.debug("PERSONA",`Resolved conflict: ${t}.${s} via ${n} for project ${e}`)}getBootstrapStatus(e){return this.db.prepare("SELECT * FROM bootstrap_state WHERE scope = ?").get(e)||null}updateBootstrapStatus(e,t,s,n){let o=new Date().toISOString();if(this.getBootstrapStatus(e)){let a=["status = ?"],d=[t];s!==void 0&&(a.push("round = ?"),d.push(s)),n&&(a.push("metadata_json = ?"),d.push(JSON.stringify(n))),t==="completed"&&(a.push("completed_at = ?"),d.push(o)),d.push(e),this.db.prepare(`UPDATE bootstrap_state SET ${a.join(", ")} WHERE scope = ?`).run(...d)}else this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t.task_name,t.status||"in_progress",t.progress||null,t.next_step||null,t.context_json?JSON.stringify(t.context_json):null,t.interrupted_tasks_json?JSON.stringify(t.interrupted_tasks_json):null,s,n,s,n),c.debug("PERSONA",`Set active task for ${e}: ${t.task_name}`)}updateActiveTask(e,t){let s=new Date().toISOString(),n=Date.now(),o=["updated_at = ?","updated_at_epoch = ?"],i=[s,n];t.status&&(o.push("status = ?"),i.push(t.status)),t.progress&&(o.push("progress = ?"),i.push(t.progress)),t.next_step&&(o.push("next_step = ?"),i.push(t.next_step)),t.context_json&&(o.push("context_json = ?"),i.push(JSON.stringify(t.context_json))),t.interrupted_tasks_json&&(o.push("interrupted_tasks_json = ?"),i.push(JSON.stringify(t.interrupted_tasks_json))),i.push(e),this.db.prepare(`UPDATE active_tasks SET ${o.join(", ")} WHERE project = ? AND status IN ('in_progress', 'blocked')`).run(...i)}completeActiveTask(e){let t=new Date().toISOString(),s=Date.now();this.db.prepare("UPDATE active_tasks SET status = 'completed', updated_at = ?, updated_at_epoch = ? WHERE project = ? AND status IN ('in_progress', 'blocked')").run(t,s,e),c.debug("PERSONA",`Completed active task for ${e}`)}getTaskCheckpoints(e){let t=this.getActiveTask(e);if(!t||!t.context_json)return[];try{let s=JSON.parse(t.context_json);return Array.isArray(s.checkpoints)?s.checkpoints:[]}catch{return[]}}setCheckpoints(e,t){let s=this.getActiveTask(e);if(!s)return;let n={};if(s.context_json)try{n=JSON.parse(s.context_json)}catch{n={}}this.updateActiveTask(e,{context_json:{...n,checkpoints:t}}),c.debug("PERSONA",`Set ${t.length} checkpoints for ${e}`)}addCheckpoint(e,t){let s=this.getTaskCheckpoints(e),n={name:t,status:s.length===0?"in_progress":"pending"};s.push(n),this.setCheckpoints(e,s),c.debug("PERSONA",`Added checkpoint "${t}" for ${e}`)}completeCheckpoint(e,t){let s=this.getTaskCheckpoints(e),n=s.findIndex(u=>u.name===t);if(n===-1)return;s[n].status="completed",s[n].completed_at=new Date().toISOString();let o=s.find(u=>u.status==="pending");o&&(o.status="in_progress");let i=s.filter(u=>u.status==="completed").length,a=s.length,d=o?.name,E=d?`Step ${i+1}/${a}: ${d}`:`Step ${i}/${a}: All complete`,p=this.getActiveTask(e);if(!p)return;let _={};if(p.context_json)try{_=JSON.parse(p.context_json)}catch{_={}}this.updateActiveTask(e,{progress:E,context_json:{..._,checkpoints:s}}),c.debug("PERSONA",`Completed checkpoint "${t}" for ${e}`)}checkCompleteness(e){let t=this.getMergedPersona(e);return new q().check(t)}checkStaleness(e){let t=new q,s=this.db.prepare("SELECT profile_type, updated_at FROM agent_profiles WHERE scope = ? OR scope = 'global'").all(e),n={};for(let o of s)n[o.profile_type]=o.updated_at;return t.checkStaleness(n)}getProjectSchema(e){let t=this.db.prepare("SELECT content_json FROM agent_profiles WHERE scope = ? AND profile_type = 'project_schema'").get(e);if(!t)return null;try{return JSON.parse(t.content_json)}catch{return null}}setProjectSchema(e,t){let s=new Date().toISOString();this.db.prepare("INSERT OR REPLACE INTO agent_profiles (scope, profile_type, content_json, updated_at) VALUES (?, 'project_schema', ?, ?)").run(e,JSON.stringify(t),s),c.debug("PERSONA",`Set project_schema for scope: ${e}`)}};var F=require("fs"),le=require("path"),$t=require("crypto");function bs(r){return(0,$t.createHash)("sha256").update(r,"utf-8").digest("hex")}function Ss(r){let e=r.split(`
`);if(e[0]?.trim()!=="---")return null;let t=-1;for(let i=1;i<e.length;i++)if(e[i].trim()==="---"){t=i;break}if(t===-1)return null;let s=e.slice(1,t),n={};for(let i of s){let a=i.indexOf(":");if(a===-1)continue;let d=i.slice(0,a).trim(),E=i.slice(a+1).trim();d==="name"?n.name=E:d==="description"?n.description=E:d==="type"&&(n.type=E)}let o=e.slice(t+1).join(`
`).trim();return{frontmatter:n,body:o}}var Ee=class{constructor(e,t){this.db=e;this.memoryDir=t}syncIncremental(){return this.runSync(!1)}fullImport(){return this.db.prepare("DELETE FROM sync_state").run(),this.runSync(!0)}runSync(e){let t={imported:0,skipped:0,errors:[]};if(c.debug(`AutoMemorySync.runSync: memoryDir=${this.memoryDir} force=${e}`),!(0,F.existsSync)(this.memoryDir))return t;let s;try{s=(0,F.readdirSync)(this.memoryDir).filter(n=>(0,le.extname)(n)===".md")}catch(n){return t.errors.push(`Failed to read memoryDir: ${String(n)}`),t}for(let n of s){let o=(0,le.join)(this.memoryDir,n),i;try{i=(0,F.readFileSync)(o,"utf-8")}catch(u){t.errors.push(`Failed to read ${n}: ${String(u)}`);continue}let a=bs(i);if(!e){let u=this.db.prepare("SELECT content_hash FROM sync_state WHERE file_path = ?").get(o);if(u&&u.content_hash===a){t.skipped++;continue}}let d=Ss(i);if(!d){t.skipped++;continue}let{frontmatter:E,body:p}=d,_=E.type;if(_==="user")try{this.upsertUserProfile(p),this.upsertSyncState(o,a,"user"),t.imported++}catch(u){t.errors.push(`Failed to sync user file ${n}: ${String(u)}`)}else if(_==="feedback")try{this.insertFeedbackObservation(E.name,p),this.upsertSyncState(o,a,"feedback"),t.imported++}catch(u){t.errors.push(`Failed to sync feedback file ${n}: ${String(u)}`)}else t.skipped++}return t}upsertUserProfile(e){let t=new Date().toISOString(),s=Date.now(),n=JSON.stringify({raw:e});this.db.prepare(`
    ...
    `).run(e,t,s,n)}};var Bt=require("crypto"),X=require("fs"),x=$(require("path"),1),_e=class{constructor(e,t){this.db=e;this.readableDir=t}checkForChanges(){let e=[],t;try{t=this.db.prepare("SELECT file_path, last_db_hash, last_file_hash, last_sync_at FROM markdown_sync").all()}catch{return[]}for(let s of t){let n=this.resolveFilePath(s.file_path);if(!(0,X.existsSync)(n)||this.hashFile(n)===s.last_file_hash)continue;let i=this.classifyFile(s.file_path);if(!i)continue;let a=s.last_db_hash!==s.last_file_hash?"conflict":"updated";e.push({filePath:s.file_path,type:i,action:a})}return e}importChanges(e){let t=0;for(let s of e){if(s.action==="conflict")continue;let n=this.resolveFilePath(s.filePath);if(!(0,X.existsSync)(n))continue;let o=(0,X.readFileSync)(n,"utf8"),i=this.hashContent(o);try{s.type==="profile"?this.importProfile(s.filePath,o):s.type==="knowledge"&&this.importKnowledge(s.filePath,o),this.db.prepare("UPDATE markdown_sync SET last_db_hash = ?, last_file_hash = ?, last_sync_at = ? WHERE file_path = ?").run(i,i,new Date().toISOString(),s.filePath),t++}catch{}}return t}importProfile(e,t){let n=x.basename(e,".md").replace(/-/g,"_"),o={},i=null,a=[];for(let _ of t.split(`
`))_.startsWith("# ")||_.startsWith("> ")||(_.startsWith("## ")?(i!==null&&(o[i]=a.length===1?a[0]:a),i=_.substring(3).trim().toLowerCase().replace(/\s+/g,"_"),a=[]):_.startsWith("- ")&&i?a.push(_.substring(2).trim()):_.trim()&&i&&!_.startsWith("#")&&a.push(_.trim()));if(i!==null&&(o[i]=a.length===1?a[0]:a),Object.keys(o).length===0)return;let d=t.match(/Scope:\s*`([^`]+)`/),E=d?d[1]:"global",p=JSON.stringify(o);this.db.prepare(`
      UPDATE agent_profiles SET content_json = ?, updated_at = ?
      WHERE scope = ? AND profile_type = ?
    `).run(p,new Date().toISOString(),E,n)}importKnowledge(e,t){if(x.basename(e,".md")==="index")return;let n=t.match(/^#\s+(.+)/m);if(!n)return;let o=n[1].trim(),i=t.split(`
`),a=[],d=!1;for(let p of i){if(p.startsWith("# ")&&!d){d=!0;continue}p.startsWith("> ")&&!a.length||d&&a.push(p)}let E=a.join(`
`).trim();E&&this.db.prepare(`
      UPDATE compiled_knowledge SET content = ?, compiled_at = ?
      WHERE topic = ?
    `).run(E,new Date().toISOString(),o)}classifyFile(e){return e.includes("/profile/")||e.includes("\\profile\\")?"profile":e.includes("/knowledge/")||e.includes("\\knowledge\\")?"knowledge":null}resolveFilePath(e){return x.isAbsolute(e)?e:x.join(this.readableDir,e)}hashFile(e){let t=(0,X.readFileSync)(e,"utf8");return this.hashContent(t)}hashContent(e){return(0,Bt.createHash)("sha256").update(e).digest("hex")}};var Me=require("fs"),Rs=ue.default.join((0,me.homedir)(),".claude","plugins","marketplaces","agent-recall","plugin",".install-version");function Os(){try{return new te}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,Ht.unlinkSync)(Rs)}catch(e){c.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return c.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function jt(r,e,t){let s=e?vt(r):ut(r);return!t||t.status!=="completed"?s+(e?`
...
`):s}function Is(r,e,t,s,n,o,i,a,d,E,p,_,u){let m=[];if(a){let f=De(a,i);if(m.push(...f),p){let O=f.join(`
`);p.consume("L0",L.estimateTokens(O))}}let g=Pt(i);if(m.push(...g),p){let f=g.join(`
`);p.consume("L0",L.estimateTokens(f))}if(E&&E.length>0){let f=`\u26A0 Persona conflicts detected (${E.length} field${E.length>1?"s":""} differ between global and project). Use /api/persona/conflicts?project=${encodeURIComponent(r)} to review.`;m.push(f,"")}if(d){let f=ye(d,i),O=f.join(`
`),I=L.estimateTokens(O);(!p||p.canFit("L1",I))&&(m.push(...f),p&&p.consume("L1",I))}if(_&&_.length>0&&m.push(..._),!d&&t.length>0&&t[0].next_steps){let f=t[0].next_steps.trim();if(f){let O;i?O=[`\x1B[33m\u25C6 Last session's next steps:\x1B[0m ${f}`,""]:O=[`**Last session's next steps:** ${f}`,""];let I=O.join(`
`),U=L.estimateTokens(I);(!p||p.canFit("L1",U))&&(m.push(...O),p&&p.consume("L1",U))}}let R=be(e);if(m.push(...Ct(r,R,s,i)),u&&u.length>0){let O=u.map(U=>`### ${U.topic}
${U.content}`).join(`

`),I=L.estimateTokens(O);p&&p.canFit("L2",I)&&(m.push(`
## Project Knowledge
`),m.push(O),p.consume("L2",I))}let T=e;if(p){let f=p.remaining("L2"),O=0;T=e.filter(I=>{let U=[I.title,I.narrative,I.facts?JSON.stringify(I.facts):null].filter(Boolean).join(" "),ke=L.estimateTokens(U);return O+ke<=f?(O+=ke,!0):!1})}let h=t.slice(0,s.sessionCount),b=Ze(h,t),N=Ae(T,b),C=et(T,s.fullObservationCount);m.push(...kt(N,C,s,n,i,!0));let P=t[0],M=T[0];xt(s,P,M)&&m.push(...wt(P,i));let G=Ie(T,s,o,n);return m.push(...Ft(G,i)),m.push(...Xt(R,s,i)),m.join(`
`).trimEnd()}async function Ue(r,e=!1){let t=he(),s=r?.cwd??process.cwd(),n=Ye(s),o=r?.globalMode??We(s),i=r?.projects||[n];r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=Os();if(!a)return"";try{let d=ue.default.join((0,me.homedir)(),".claude","memory");if((0,Me.existsSync)(d)){let p=new Ee(a.db,d).syncIncremental();p.imported>0&&c.debug("CONTEXT",`Auto memory sync: imported ${p.imported} entries`)}}catch(d){c.debug("CONTEXT","Auto memory sync failed (non-blocking)",{error:String(d)})}try{let d=ue.default.join((0,me.homedir)(),".agent-recall","readable");if((0,Me.existsSync)(d)){let E=new _e(a.db,d),p=E.checkForChanges();if(p.length>0){let _=E.importChanges(p);_>0&&c.debug("CONTEXT",`Markdown import: imported ${_} user-edited files`)}}}catch(d){c.debug("CONTEXT","Markdown import check failed (non-blocking)",{error:String(d)})}try{if(o){c.debug("CONTEXT","Global Quick Mode \u2014 skipping project-specific context",{cwd:s,project:n});let N=null,C=null,P=null;try{let f=new K(a.db);N=f.getMergedPersona("__global__"),P=f.getBootstrapStatus("__global__"),C=f.getActiveTask(n)}catch(f){c.debug("CONTEXT","Persona query skipped in global mode (tables may not exist yet)",{},f)}let M=[],G=new L(t.tokenBudget||3e3);if(e?M.push("\x1B[36m\x1B[1m\u25CF Global Mode\x1B[0m \x1B[2m\u2014 launched from home directory\x1B[0m",""):M.push("**Global Mode** \u2014 launched from home directory",""),N){let f=De(N,e);M.push(...f);let O=f.join(`
`);G.consume("L0",L.estimateTokens(O))}if(C){let f=ye(C,e),O=f.join(`
`),I=L.estimateTokens(O);G.canFit("L1",I)&&(M.push(...f),G.consume("L1",I))}if(!N?.agent_soul?.name){let f=jt(n,e,P);f&&M.push(f)}return M.join(`
`).trimEnd()}let d=i.length>1?Qe(a,i,t):Se(a,n,t),E=i.length>1?ze(a,i,t):Re(a,n,t),p=null,_=null,u=null,m=[],g=null;try{g=new K(a.db),p=g.getMergedPersona(n),_=g.getActiveTask(n),u=g.getBootstrapStatus("__global__"),m=g.detectConflicts(n)}catch(N){c.debug("CONTEXT","Persona query skipped (tables may not exist yet)",{},N)}if(d.length===0&&E.length===0&&!p?.agent_soul?.name)return jt(n,e,u);let R=[];if(u?.status==="completed"&&g)try{let N=g.checkCompleteness(n),C=g.checkStaleness(n);N.percentage<80&&N.gaps.length>0&&R.push(`
> Profile ${N.percentage}% complete. Missing: ${N.gaps.join(", ")}`),C.staleFields.length>0&&R.push(`
> Some profile fields not updated in 90+ days: ${C.staleFields.join(", ")}`)}catch(N){c.debug("CONTEXT","Completeness check failed (non-blocking)",{error:String(N)})}let T=new L(t.tokenBudget||3e3),h=[];try{h=a.getCompiledKnowledge(n)}catch{}return Is(n,d,E,t,s,r?.session_id,e,p,_,m,T,R,h)}finally{a.close()}}0&&(module.exports={generateContext});
